...
This is a hello world app for generic deploy of LNUP
...
.. code-block:: bash
    ...
    heroku run python helloLNUP/manage.py syncdb --noinput --settings=config.settings
    heroku run python helloLNUP/manage.py migrate --settings=config.settings
    heroku run python helloLNUP/manage.py collectstatic --settings=config.settings
